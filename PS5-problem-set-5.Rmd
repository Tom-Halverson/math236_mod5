...
* You can download the [Rmd source file  for this problem set](https://github.com/Tom-Halverson/math236_mod5/blob/main/PS5-problem-set-5.Rmd).
...
Find the dimension of the subspace $Z$ of $\mathbb{R}^5$ of vectors below
$$
Z = \left\{
...
a. By hand, or using R, compute $A v_1$, $A v_2$, and $A v_3$ and show that in each case $A v_i$ is a scalar multiple of $v_i$. Be sure to report the scalar in each case. 
