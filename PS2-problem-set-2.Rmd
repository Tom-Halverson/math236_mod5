...
Use R to solve this problem. Do your computations in an R markdown file.  Knit the file to HTML and include it with your homework. Here you [can download a template for doing this problem](https://github.com/Tom-Halverson/math236_221/blob/main/PS-2.9.template.Rmd) (including the matrix typed out for you!).
$$
A =\left[
\begin{array}{cccccc}
 12 & 10 & -6 & 8 & 4 & -18 \\
