...
* You can download the [Rmd source file for this problem set](https://github.com/Tom-Halverson/math236_f21/blob/main/PS2-problem-set-2.Rmd).
...
$$
  ...
  a. Use RStudio to show that the columns  of $\mathsf{A}$ span $\mathbb{R}^4$. You don't need to turn in an R file here, just report any row reductions that you perform.
...
Use R to solve this problem. Do your computations in an R markdown file.  Knit the file to HTML and include it with your homework. Here you [can download a template for doing this problem](https://github.com/Tom-Halverson/math236_f21/blob/main/PS-2.9.template.Rmd) (including the matrix typed out for you!).
$$
A =\left[
\begin{array}{cccccc}
 12 & 10 & -6 & 8 & 4 & -18 \\
